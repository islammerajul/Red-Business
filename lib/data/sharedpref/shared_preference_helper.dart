...
class SharedPreferenceHelper {
  ...
  Future<void> setUserFromSignup(String user_name) {
    return _sharedPreference.setString(Preferences.user_name,user_name);
  }

  Future<void> setUserType(String user_type) {
    return _sharedPreference.setString(Preferences.user_type,user_type);
  }
/*
